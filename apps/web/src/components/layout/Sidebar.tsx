...
export function Sidebar() {
  return (
    <aside className="hidden w-64 flex-shrink-0 border-r border-gray-200 bg-white lg:block dark:border-gray-800 dark:bg-gray-900">
...
export function MobileSidebar({ isOpen, onClose }: MobileSidebarProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'absolute inset-0 bg-gray-900/50 transition-opacity duration-300 dark:bg-black/60',
      ...
      <aside
        className={cn(
          'absolute inset-y-0 left-0 w-72 bg-white shadow-xl transition-transform duration-300 ease-in-out dark:bg-gray-900',
